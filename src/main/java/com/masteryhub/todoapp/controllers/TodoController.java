...
public class TodoController {
  ...
  //    public ResponseEntity<String> softDeleteAllTodo(@RequestHeader("Authorization") String
  // token) {
  ...
  //    public ResponseEntity<List<ResponseTodoDto>> restoreAllTodo(@RequestHeader("Authorization")
  // String token) {
